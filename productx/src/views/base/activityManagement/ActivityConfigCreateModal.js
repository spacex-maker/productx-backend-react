...
const ActivityConfigCreateModal = ({ isVisible, onCancel, onFinish, form }) => {
  ...
  const resetStates = () => {
    ...
    setShareTitleZh('');
    setShareTitleEn('');
    setThemeColor('#7B2CBF');
    setTargetAction('register');
    setRewardType('video_credits');
    setRewardAmount(30);
    setRegisterRewardInviter(100);
    setRegisterRewardInvitee(50);
    setAutoIssueOnRegister(true);
    setUploading({});
  };
...
export default ActivityConfigCreateModal;
